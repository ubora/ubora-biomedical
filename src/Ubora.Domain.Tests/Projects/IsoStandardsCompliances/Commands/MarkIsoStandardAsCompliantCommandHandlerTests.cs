...
namespace Ubora.Domain.Tests.Projects.IsoStandardsCompliances.Commands
{
    public class MarkIsoStandardAsCompliantCommandHandlerTests
    {
        ...
        public MarkIsoStandardAsCompliantCommandHandlerTests()
        {
        ...
        {
            var handlerUnderTest = new MarkIsoStandardAsCompliantCommand.Handler(_documentSessionMock.Object);
            ...
            var @event = (IsoStandardMarkedAsCompliantEvent)appendedEvents.Single();
