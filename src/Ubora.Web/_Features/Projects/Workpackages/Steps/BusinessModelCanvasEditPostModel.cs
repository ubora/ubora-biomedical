...
{
    public class BusinessModelCanvasEditPostModel
    {
        public string ValueProposalDescriptionQuillDelta { get; set; }
        public string GrowthStrategyDescriptionQuillDelta { get; set; }
        public string KeyResourcesAndPartnersDescriptionQuillDelta { get; set; }
