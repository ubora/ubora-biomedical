        ...
        public class Factory
        {
            ...
            public virtual HealthTechnologySpecificationsViewModel Create(HealthTechnologySpecificationsInformation domainAggregate)
            {
                ...
                model.EnergyRequirements = new EnergyRequirementsViewModel
                {
                    ...
                    IfPowerSupplyForRechargingThenRequiredBatteryLifeInHours = (int) domainAggregate.EnergyRequirements.PowerSupplyForRecharging.PowerSupplyForRechargingRequiredBatteryLife.TotalHours,
                    ...
                    IfPowerSupplyForRechargingThenRequiredTimeToRechargeInHours = (int) domainAggregate.EnergyRequirements.PowerSupplyForRecharging.PowerSupplyForRechargingRequiredTimeToRecharge.TotalHours,
                    ...
                    IfSolarPowerThenBatteryLifeInHours = (int) domainAggregate.EnergyRequirements.SolarPower.SolarPowerBatteryLife.TotalHours,
                    IfSolarPowerThenBatteryLifeInMinutes = domainAggregate.EnergyRequirements.SolarPower.SolarPowerBatteryLife.Minutes,
                    IfSolarPowerThenTimeInSunlightRequiredToChargeInHours = (int) domainAggregate.EnergyRequirements.SolarPower.SolarPowerTimeInSunlightRequiredToCharge.TotalHours,
