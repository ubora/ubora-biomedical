            ...
            public HealthTechnologySpecificationsResult Create(HealthTechnologySpecificationsInformation healthTechnologySpecifications)
            {
                return new HealthTechnologySpecificationsResult
                {
                    ...
                    EnergyRequirementsViewModel = new EnergyRequirementsViewModel
                    {
                        ...
                        IfPowerSupplyForRechargingThenRequiredBatteryLifeInHours = healthTechnologySpecifications.EnergyRequirements.PowerSupplyForRecharging.PowerSupplyForRechargingRequiredBatteryLife.Hours,
                        ...
                        IfPowerSupplyForRechargingThenRequiredTimeToRechargeInHours = healthTechnologySpecifications.EnergyRequirements.PowerSupplyForRecharging.PowerSupplyForRechargingRequiredTimeToRecharge.Hours,
                        ...
                        IfSolarPowerThenBatteryLifeInHours = healthTechnologySpecifications.EnergyRequirements.SolarPower.SolarPowerBatteryLife.Hours,
                        ...
                        IfSolarPowerThenTimeInSunlightRequiredToChargeInHours = healthTechnologySpecifications.EnergyRequirements.SolarPower.SolarPowerTimeInSunlightRequiredToCharge.Hours,
