...
Scenario: I sign in and send feedback
    ...
    When I wait for the element "textarea.feedback-input"
        And I set value "Is this the feedback you are looking for?" to the element "textarea.feedback-input"
...
Scenario: I try to send feedback but cancel it
    ...
    When I wait for the element "textarea.feedback-input"
        And I set value "There is no feedback for you." to the element "textarea.feedback-input"
