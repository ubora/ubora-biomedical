...
Scenario: I submit valid registration form then user is logged in and full name displayed
    When I click on the element "a=Sign in/sign up"
    Then I expect the title of the page "Sign in to UBORA - UBORA"
    When I sign up as "email@email.com" first name "TestFirstName" last name "TestLastName"
...
Scenario: I sumbit empty registration form and try to create an account
    ...
    Then I expect the element "span=The LastName field is required." is visible
    ...
    Then I expect the element "span=The Confirm password field is required." is visible
    Then I expect the element "span=This field is required." is visible
    Then I expect the title of the page "Sign up - UBORA"