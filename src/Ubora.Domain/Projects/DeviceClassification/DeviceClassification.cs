...
namespace Ubora.Domain.Projects.DeviceClassification
{
    public class DeviceClassification : IDeviceClassification
    {
        ...
        {
            var mainQuestion1 = new MainQuestion("Question 1?");
            var mainQuestion2 = new MainQuestion("Question 2?");
            var mainQuestion3 = new MainQuestion("Question 3?");
            var mainQuestion4 = new MainQuestion("Question 4?");

            var pair2 = new PairedMainQuestions(null, mainQuestion3, mainQuestion4);
            ...
            var subQuestion1_1 = new SubQuestion("Sub question 1.1", pair1, mainQuestion1);
            var subQuestion1_2 = new SubQuestion("Sub question 1.2", pair1, mainQuestion1);
            var subQuestion1_3 = new SubQuestion("Sub question 1.3", pair1, mainQuestion1);
            var subQuestion1_4 = new SubQuestion("Sub question 1.4", pair1, mainQuestion1);

            var subQuestion1_1_1 = new SubQuestion("Sub question 1.1.1", pair1, subQuestion1_1);
            var subQuestion1_1_2 = new SubQuestion("Sub question 1.1.2", pair1, subQuestion1_1);

            SubQuestions.Add(subQuestion1_1);
            SubQuestions.Add(subQuestion1_1_1);
            SubQuestions.Add(subQuestion1_1_2);
            SubQuestions.Add(subQuestion1_2);
            SubQuestions.Add(subQuestion1_3);
            SubQuestions.Add(subQuestion1_4);

            var specialMainQuestion3 = new SpecialMainQuestion("Special question 3?", null);
            var specialMainQuestion2 = new SpecialMainQuestion("Special question 2?", specialMainQuestion3);
            var specialMainQuestion1 = new SpecialMainQuestion("Special question 1?", specialMainQuestion2);

            SpecialMainQuestions.Add(specialMainQuestion1);
            SpecialMainQuestions.Add(specialMainQuestion2);
            SpecialMainQuestions.Add(specialMainQuestion3);

            var specialSubQuestion1_1 = new SpecialSubQuestion("Special question 1.1?", specialMainQuestion1);
            var specialSubQuestion1_2 = new SpecialSubQuestion("Special question 1.2?", specialMainQuestion1);
            var specialSubQuestion1_3 = new SpecialSubQuestion("Special question 1.3?", specialMainQuestion1);

            var specialSubQuestion2_1 = new SpecialSubQuestion("Special question 2.1?", specialMainQuestion2);
            var specialSubQuestion2_2 = new SpecialSubQuestion("Special question 2.2?", specialMainQuestion2);

            SpecialSubQuestions.Add(specialSubQuestion1_1);
            SpecialSubQuestions.Add(specialSubQuestion1_2);
            SpecialSubQuestions.Add(specialSubQuestion1_3);
            SpecialSubQuestions.Add(specialSubQuestion2_1);
            SpecialSubQuestions.Add(specialSubQuestion2_2);

            Classifications.Add(new Classification("I", 1, new List<Guid> { subQuestion1_1_1.Id, specialMainQuestion3.Id, specialSubQuestion1_1.Id, specialSubQuestion2_2.Id }));
            Classifications.Add(new Classification("IIa", 2, new List<Guid> { subQuestion1_2.Id, specialSubQuestion1_2.Id }));
            Classifications.Add(new Classification("IIb", 3, new List<Guid> { subQuestion1_3.Id, specialSubQuestion2_1.Id }));
            Classifications.Add(new Classification("III", 4, new List<Guid> { subQuestion1_4.Id, subQuestion1_1_2.Id, specialSubQuestion1_3.Id }));
        }
