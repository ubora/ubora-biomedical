...
namespace Ubora.Domain.Projects.DeviceClassification
{
    public class DeviceClassification : IDeviceClassification
    {
        ...
        {
            var note1 = new Note("'invasive device' means any device which, in whole or in part, penetrates inside the body, either through a body orifice or through the surface of the body;");
            var note3 = new Note("'active device' means any device, the operation of which depends on a source of energy other than that generated by the human body for that purpose, or by gravity, and which acts by changing the density of or converting that energy. Devices intended to transmit energy, substances or other elements between an active device and the patient, without any significant change, shall not be deemed to be active devices. Software shall also be deemed to be an active device;");

            var mainQuestion1 = new MainQuestion("Is your device NON INVASIVE?", note1);
            var mainQuestion2 = new MainQuestion("Is your device INVASIVE?", note1);

            var mainQuestion3 = new MainQuestion("Is your device ACTIVE?", note3);
            ...
            var note2_1 = new Note(@"'Surgically invasive device' means: 
...
");
            var subQuestion2_1 = new SubQuestion("Is it NON-SURGICALLY INVASIVE?", pair1, mainQuestion2, note2_1);
