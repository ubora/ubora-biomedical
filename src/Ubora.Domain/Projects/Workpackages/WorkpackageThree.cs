...
namespace Ubora.Domain.Projects.Workpackages
{
    public class WorkpackageThree : Workpackage<WorkpackageThree>
    {
        private void Apply(WorkpackageThreeOpenedEvent e)
        {
            ...
            _steps.Add(new WorkpackageStep("GeneralProductDescription_ElectronicAndFirmware_CommercialParts", "Electronic & firmware", ""));
            ...
            _steps.Add(new WorkpackageStep("GeneralProductDescription_SystemIntegration_Optimization", "Optimization: materials, processes and performance", ""));
