...
namespace Ubora.Domain.ClinicalNeeds.Events
{
    ...
    {
        public ClinicalNeedIndicatedEvent(UserInfo initiatedBy, Guid clinicalNeedId, string title, string description, string clinicalNeedTag, string areaOfUsageTag, string potentialTechnologyTag, string keywords)
            : base(initiatedBy)
        {
